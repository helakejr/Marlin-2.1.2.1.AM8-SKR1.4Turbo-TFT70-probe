...
//#define SENSORLESS_BACKOFF_MM  { 2, 2 }       // (linear=mm, rotational=°) Backoff from endstops before sensorless homing
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  20, 20 }, { 170,  20 }, { 160, 160 }, { 20, 160 } }

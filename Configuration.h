...
#define STRING_CONFIG_H_AUTHOR "(Ed Lake, Anet AM8 SKR 1.4Turbo-TFT70)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 2		// Host port
...
#define CUSTOM_MACHINE_NAME "Anet AM8 SKR 1.4Turbo-TFT70"
...
#define Z_DRIVER_TYPE  TMC2209		//TMC2209 drives drives 2 stepper motors
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // (measured after M106 S255 with M303 E0 S210 C8)
    ...
    #define DEFAULT_Kp_LIST {  24.4806,  20.00 }
    #define DEFAULT_Ki_LIST {   1.7000,   1.25 }
    #define DEFAULT_Kd_LIST {  88.1303,  86.00 }
  #else
    //PID-Autotune: measured after M106 S255 (100%fan) with M303 E0 S200 C8
	#define DEFAULT_Kp 24.4806
	#define DEFAULT_Ki  1.7000
	#define DEFAULT_Kd 88.1303
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // ANET A8 PID-Autotune: M303 E-1 S60 C8
	#define DEFAULT_bedKp 153.2959
	#define DEFAULT_bedKi  28.1794
	#define DEFAULT_bedKd 555.9532
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100.3, 100.25, 400, 98.67 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-27, -44, -3.65}
